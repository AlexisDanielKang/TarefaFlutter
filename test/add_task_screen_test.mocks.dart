...
// in tarefa/test/add_task_screen_test.dart.
...
import 'package:tarefa/api/api_service.dart' as _i2;
import 'package:tarefa/controller/task_controller.dart' as _i3;
import 'package:tarefa/model/task_model.dart' as _i5;
...
class MockTaskController extends _i1.Mock implements _i3.TaskController {
  MockTaskController() {
  ...
  @override
  _i4.Future<void> addTask(_i5.TaskModel? task) => (super.noSuchMethod(
        Invocation.method(
          #addTask,
          [task],
        ),
